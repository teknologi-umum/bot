 ...
 * @class redisClient
 *
 * Helps to convert synchronous Redis calls to asynchronous.
 */
class redisClient {
  /**
   *
   ...
   */
  constructor(client) {
    /** @type {import('redis'.RedisClient)} Redis client instance */
    this.client = client;
  }
  /**
   ...
   * The connection is closed as soon as all pending replies have been written to the this.client.
  ...
  async MGET(...key) {
    return new Promise(function (resolve, reject) {
      this.client.MGET(key.flat(99), (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async SET(key, value, options) {
    return new Promise(function (resolve, reject) {
      this.client.SET(key, value, options?.mode ?? '', options?.flag ?? '', options?.duration ?? 0, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async SETNX(key, value) {
    return new Promise(function (resolve, reject) {
      this.client.SETNX(key, value, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async SETEX(key, seconds, value) {
    return new Promise(function (resolve, reject) {
      this.client.SETEX(key, seconds, value, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async MSET(...keys) {
    return new Promise(function (resolve, reject) {
      this.client.MSET(keys.flat(99), (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async MSETNX(...keys) {
    return new Promise(function (resolve, reject) {
      this.client.MSETNX(keys.flat(99), (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async RENAME(key, newkey) {
    return new Promise(function (resolve, reject) {
      this.client.RENAME(key, newkey, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async EXPIRE(key, seconds) {
    return new Promise(function (resolve, reject) {
      this.client.EXPIRE(key, seconds, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async TTL(key) {
    return new Promise(function (resolve, reject) {
      this.client.TTL(key, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async PERSIST(key) {
    return new Promise(function (resolve, reject) {
      this.client.PERSIST(key, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async TYPE(key) {
    return new Promise(function (resolve, reject) {
      this.client.TYPE(key, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async DECR(key) {
    return new Promise(function (resolve, reject) {
      this.client.DECR(key, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async APPEND(key, value) {
    return new Promise(function (resolve, reject) {
      this.client.APPEND(key, value, (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async DEL(...key) {
    return new Promise(function (resolve, reject) {
      this.client.DEL(key.flat(99), (error, reply) => {
        if (error) return reject(error);
        return resolve(reply);
      });
    });
  ...
  async HSET(key, ...hash) {
    return new Promise(function (resolve, reject) {
      this.client.HSET(key, ...hash, (err, reply) => {
        if (err) return reject(err);
        return resolve(reply);
      });
    });
  ...
  async HMGET(key, ...hash) {
    return new Promise(function (resolve, reject) {
      this.client.HMGET(key, ...hash, (err, reply) => {
        if (err) return reject(err);
        return resolve(reply);
      });
    });
   ...
   * @param {String} key
   * @returns {Promise<[key: string]: string>} list of fields and their values stored in the hash, or an empty list when key does not exist.
